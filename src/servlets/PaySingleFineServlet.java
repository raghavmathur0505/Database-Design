 ...
 */
@WebServlet("/PaySingleFineServlet")
public class PaySingleFineServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()54
	 */
	public PaySingleFineServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String dateIn = request.getParameter("dateIn");//yes if book returned
		String paid = request.getParameter("paid"); //yes if fine already paid
		...
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:9443/LibraryManagement/rest/paysinglefineservice/view");
