 ...
 */
@WebServlet("/CheckUnreturedBookServlet")
public class CheckUnreturedBookServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()54
	 */
	public CheckUnreturedBookServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (cardStatus.equalsIgnoreCase("true")) {
			...
			//session1.setAttribute("PRODUCTS1", products);
			session1.setAttribute("CARDID", search);
			RequestDispatcher rd = request.getRequestDispatcher("ViewAllSumFines2.jsp");
			rd.forward(request, response);
		}
