 ...
 */
@WebServlet("/ViewFineByCardIdServlet")
public class ViewFineByCardIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()54
	 */
	public ViewFineByCardIdServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			WebResource webResource = client
					.resource("http://localhost:9443/LibraryManagement/rest/viewfinebycardid/view");
